...
public:
    ...
    virtual void showInfo() {
        std::cout << "fio: " << this->fio << "\n";
        std::cout << "email: " << this->email << "\n";
        std::cout << "list of documents: " << this->doc_list << "\n";
...
public:
    ...
    Vacancy& operator+(unsigned ammount) {
        auto temp = *this;
        temp.pay += ammount;
        return temp;
    }
...
public:
    ...
    void showInfo() {
        User::showInfo();
        std::cout << "Organisation: " << this->org;
        std::cout << "List of vacansions: " << this->vacans_list;
    }
...
public:
    ...
    void showInfo() {
        ...
        std::cout << "specialization: " << this->spec;
        std::cout << "List of otclicks: " << this->otkl_list;
    }
